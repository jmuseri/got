...
@RestController
@RequestMapping("/funcional/tipoTramite")
@Api(value = "funcional", description = "funcional/TipoTramite Operations in GOT")
public class FuncionalTipoTramiteController {
